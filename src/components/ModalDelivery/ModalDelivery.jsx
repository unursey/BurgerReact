...
import { changeTouch, getWarning, submitForm, updateFormValue, validateForm } from '../../store/form/formSlice';
    ...
    >
      <div className={style.mdelivery}>
        <div className={style.container}>
          ...
          {form.warning && Object.entries(form.errors).map(([key, err]) => (
            <p className={style.warning} key={key}>* {err}</p>
          ))}
        </div>
